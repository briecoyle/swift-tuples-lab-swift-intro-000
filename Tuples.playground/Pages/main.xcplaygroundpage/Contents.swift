 ...
 */
// write your code here
let human = (name: "Carol Ann", age: 60)
 ...
 */
print("I cannot change human's age because I declared human to be a constant.")
